        ...
        <div class="col-sm-9 store-pane" id="settings-checkout">
            ...
            <div class="form-group">
                ...
                <div class="checkbox form-check">
                    ...
                    <div class="radio"><label><?= $form->radio('shoppingDisabled', 'all', $shoppingDisabled == 'all'); ?><?php echo t('Disabled (Catalog Mode)'); ?></label></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="checkbox form-check">
                    ...
                    <div class="radio"><label><?= $form->radio('cartMode', 'slide', $cartMode == 'slide'); ?><?php echo t('Slide'); ?></label></div>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="checkbox form-check">
                    <div class="radio"><label><?= $form->radio('guestCheckout', 'always', $guestCheckout == 'always'); ?><?php echo t('Always (unless login required for products in cart)'); ?></label></div>
                    <div class="radio"><label><?= $form->radio('guestCheckout', 'option', $guestCheckout == 'option'); ?><?php echo t('Offer as checkout option'); ?></label></div>
                    <div class="radio"><label><?= $form->radio('guestCheckout', 'off', $guestCheckout == 'off' || $guestCheckout == ''); ?><?php echo t('Disabled'); ?></label></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="checkbox form-check">
                    <div class="radio"><label><?= $form->radio('companyField', 'off', $companyField == 'off' || $companyField == ''); ?><?php echo t('Hidden'); ?></label></div>
                    <div class="radio"><label><?= $form->radio('companyField', 'optional', $companyField == 'optional'); ?><?php echo t('Optional'); ?></label></div>
                    <div class="radio"><label><?= $form->radio('companyField', 'required', $companyField == 'required'); ?><?php echo t('Required'); ?></label></div>
                </div>
            </div>
