...
$importViews = array('import','productsimported','importproducts');
...
<?php } elseif(in_array($controller->getTask(),$listViews)) { ?>
    ...
    <div class="ccm-dashboard-header-buttons">
        ...
        <a href="<?= \URL::to('/dashboard/store/products/', 'import')?>" class="btn btn-primary"><?= t("Import Products")?></a>
...
<?php } elseif (in_array($controller->getTask(),$importViews)){ ?>
    	...
    	$(document).ready(function () {
          ...
          $('#loading_img').show();
              ...
              var data = new FormData($('form')[0]);
                    ...
                    window.location.replace("<?= \URL::to('/dashboard/store/products/', 'import')?>");
