                    ...
                    <div class="store-checkout-form-group-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <?= $form->text('store-checkout-billing-first-name', $customer->getValue('billing_first_name'), ['required' => 'required', 'placeholder' => t('First Name')]); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="store-checkout-billing-last-name"><?= t('Last Name') ?></label>
                                    <?= $form->text('store-checkout-billing-last-name', $customer->getValue('billing_last_name'), ['required' => 'required', 'placeholder' => t('Last Name')]); ?>
                                </div>
                            </div>
                        </div>
                        <?php if ($companyField == 'required' || $companyField == 'optional') {
                            if ($companyField == 'required') {
                                $companyOptions = ['required' => 'required', 'placeholder' => t('Company')];
                            } else {
                                $companyOptions = ['placeholder' => t('Company (optional)')];
                            }
                        ?>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 mb-3">
                                <div class="form-group">
                                    <?= $form->text('store-checkout-billing-address-1', $customer->getAddressValue('billing_address', 'address1'), ['required' => 'required', 'placeholder' => t('Street Address')]); ?>
                                </div>
                            </div>
                            <div class="col-md-5 mb-3">
                                <div class="form-group">
                                    <?= $form->text('store-checkout-billing-address-2', $customer->getAddressValue('billing_address', 'address2'), ['placeholder' => t('Apartment, unit, etc (optional)')]); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <?= $form->text('store-checkout-billing-city', $customer->getAddressValue('billing_address', 'city'), ['required' => 'required', 'placeholder' => t('City')]); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <?= $form->text('store-checkout-billing-zip', $customer->getAddressValue('billing_address', 'postal_code'), ['required' => 'required', 'placeholder' => t('Postal Code')]); ?>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <?= $form->telephone('store-checkout-billing-phone', $customer->getValue('billing_phone'), ['required' => 'required', 'placeholder' => t('Phone Number')]); ?>
                                </div>
                            </div>
                        </div>
