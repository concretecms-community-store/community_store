...
class Controller extends Package
{
    ...
    public function on_start()
    {
        ...
        $al->register('javascript', 'community-store-autocomplete', 'js/autoComplete.js', array('version' => '1', 'position' => Asset::ASSET_POSITION_FOOTER, 'minify' => false, 'combine' => false), $this);
