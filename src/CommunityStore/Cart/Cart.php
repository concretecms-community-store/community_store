...
use Concrete\Package\CommunityStore\Src\CommunityStore\Event\CommunityStoreBasketEvent;
...
class Cart
{
    ...
    public static function add($data)
    {
        ...
        $event = new CommunityStoreBasketEvent('add');
        $event->setProduct($product);
        $event->setData($data);

        \Events::dispatch(CommunityStoreBasketEvent::CART_PRE_ADD, $event);
        ...
        \Events::dispatch(CommunityStoreBasketEvent::CART_ACTION, $event);
        \Events::dispatch(CommunityStoreBasketEvent::CART_POST_ADD, $event);
    ...
    public static function update($data)
    {
        ...
        $event = new CommunityStoreBasketEvent('update');
        $event->setProduct($product);
        $event->setData($data);

        \Events::dispatch(CommunityStoreBasketEvent::CART_PRE_UPDATE, $event);
        ...
        \Events::dispatch(CommunityStoreBasketEvent::CART_ACTION, $event);
        \Events::dispatch(CommunityStoreBasketEvent::CART_POST_UPDATE, $event);
    ...
    public static function remove($instanceID)
    {
        ...
        $cart = self::getCart();
        $product = StoreProduct::getByID((int) $cart[$instanceID]['product']['pID']);
        $event = new CommunityStoreBasketEvent('remove');
        $event->setProduct($product);

        \Events::dispatch(CommunityStoreBasketEvent::CART_PRE_REMOVE, $event);
        ...
        \Events::dispatch(CommunityStoreBasketEvent::CART_ACTION, $event);
        \Events::dispatch(CommunityStoreBasketEvent::CART_POST_REMOVE, $event);
    }

    public static function clear()
    {
        $event = new CommunityStoreBasketEvent('clear');
        \Events::dispatch(CommunityStoreBasketEvent::CART_PRE_CLEAR, $event);
        Session::set('community_store.smID', false);
        $cart = self::getCart();
        unset($cart);
        ...
        self::$cart = null;
        \Events::dispatch(CommunityStoreBasketEvent::CART_ACTION, $event);
        \Events::dispatch(CommunityStoreBasketEvent::CART_POST_CLEAR, $event);
    }
